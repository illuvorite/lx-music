...
dd
  ...
  .gap-top
    base-checkbox(id="setting_player_auto_switch_source" :model-value="appSetting['player.autoSwitchSource']" :label="$t('setting__play_auto_switch_source')" @update:model-value="updateSetting({'player.autoSwitchSource': $event})")
  .gap-top
